...
#specify Restrained emin eq_wat2
...
gmx grompp -f eqwat.mdp -p topol.top -c emin2.gro -o eqwat2.tpr -r emin2.gro -maxwarn 1

mkdir -p Reqwat2
mv eqwat2.tpr Reqwat2/ || echo "failed to move tpr 2"
cd Reqwat2
