#!/bin/bash
# Name of the job
#SBATCH -J Gromacs-gpu-production2
#SBATCH -N 1
# Use for 4 tasks
#SBATCH -n 4
...
gmx grompp -f production.mdp -p ../topol.top -c eqwat2.gro -o run2.tpr

gmx mdrun -s run2.tpr -c prod_output2.gro -cpo state2.cpt -x traj_comp2.xtc -gputasks 0123 -nb gpu -pme gpu -bonded cpu -npme 1 $ntmpi -ntomp $ntomp -deffnm mdprod2
